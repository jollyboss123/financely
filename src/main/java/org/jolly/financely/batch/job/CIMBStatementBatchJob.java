...
public class CIMBStatementBatchJob {
    ...
    @Bean
    public MultiResourceItemReader<RawTransaction> cimbItemsReader(StatementPdfReader cimbItemReader) {
    ...
    @Bean
    public StatementPdfReader cimbItemReader(@Qualifier("StatementPdfReader") StatementPdfReader flatFileItemReader) {
